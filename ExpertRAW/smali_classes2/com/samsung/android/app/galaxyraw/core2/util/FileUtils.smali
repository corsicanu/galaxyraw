.class public Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;
    ...
    sput-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
...
.method public static varargs createDirectories(Ljava/nio/file/Path;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p1}, Ljava/nio/file/attribute/PosixFilePermissions;->asFileAttribute(Ljava/util/Set;)Ljava/nio/file/attribute/FileAttribute;
    ...
    sget-object p1, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
...
.method public static createFile(Ljava/io/File;)Ljava/io/File;
    ...
    sget-object p0, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
    ...
    sget-object v1, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
...
.method public static varargs deleteDirectory(Ljava/nio/file/Path;[Ljava/lang/Boolean;)V
    ...
    :cond_0
    :try_start_1
    new-array v2, v1, [Ljava/nio/file/FileVisitOption;

    invoke-static {p0, v2}, Ljava/nio/file/Files;->walk(Ljava/nio/file/Path;[Ljava/nio/file/FileVisitOption;)Ljava/util/stream/Stream;
    ...
    sget-object v1, Lcom/samsung/android/app/galaxyraw/core2/util/-$$Lambda$FileUtils$IcaTCHG79o0ez702S_vZ2XtIGGA;->INSTANCE:Lcom/samsung/android/app/galaxyraw/core2/util/-$$Lambda$FileUtils$IcaTCHG79o0ez702S_vZ2XtIGGA;
    ...
    invoke-static {p1, p0}, Lcom/samsung/android/app/galaxyraw/core2/util/CLog;->w(Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public static varargs deleteFiles([Ljava/nio/file/Path;)V
    ...
    sget-object v3, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
...
.method public static dumpImageIfEnabled(Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;Ljava/lang/String;Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->isDumpCaptureImageEnabled()Z
    ...
    invoke-virtual {p2}, Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;->getSize()Landroid/util/Size;
    ...
    invoke-virtual {p2}, Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;->getTimestamp()J
    ...
    invoke-virtual {p2}, Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;->getFormat()I
    ...
    const-string p1, "%s_%dx%d_%d.%s"

    invoke-static {v0, p1, v1}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->dumpToFile(Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;Ljava/lang/String;)V

    :cond_1
    return-void
.end method

.method public static dumpImageIfEnabled(Ljava/nio/ByteBuffer;Ljava/lang/String;Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    const-string p1, "%s_%dx%d_%d.nv21"

    invoke-static {v0, p1, v1}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->dumpToFile(Ljava/nio/ByteBuffer;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public static dumpImageIfEnabled([BLjava/lang/String;Lcom/samsung/android/app/galaxyraw/core2/util/ImageInfo;)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->dumpToFile([BLjava/lang/String;)V

    :cond_1
    return-void
.end method

.method public static dumpToFile(Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :cond_0
    const-string v0, "/data/user/0/com.samsung.android.app.galaxyraw/files/.dump"

    invoke-static {v0}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->makeDirectory(Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;->get(Ljava/io/File;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static isDumpCaptureImageEnabled()Z
    ...
    sget-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;->CAMERA_CAPTURE_DUMP:Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;
...
.method public static isDumpCaptureImageInNativeEnabled()Z
    .locals 2

    sget-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;->CAMERA_CAPTURE_NATIVE_DUMP:Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;
...
.method public static isDumpPreviewImageEnabled()Z
    ...
    sget-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;->CAMERA_PREVIEW_DUMP:Lcom/samsung/android/app/galaxyraw/core2/util/DebugUtils$DebugMode;
...
.method static synthetic lambda$deleteDirectory$0(Ljava/nio/file/Path;)V
    .locals 2
...
.method public static regenerateFileNameIfExists(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
    ...
    invoke-static {v4, v5}, Lcom/samsung/android/app/galaxyraw/core2/util/CLog;->d(Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->getFileNameWithoutExtension(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->getFileExtension(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
    ...
    invoke-static {v5, p0}, Lcom/samsung/android/app/galaxyraw/core2/util/CLog;->i(Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public static varargs regeneratePathIfExistsAndCreate(Ljava/nio/file/Path;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    sget-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->getFileName(Ljava/nio/file/Path;[Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Lcom/samsung/android/app/galaxyraw/core2/util/FileUtils;->getFileExtension(Ljava/nio/file/Path;)Ljava/lang/String;

    move-result-object v2

    array-length v3, p1

    const-string v4, "regeneratePathIfExistsAndCreate is failed : "
...
.method public static saveFromFileToUri(Landroid/content/Context;Ljava/nio/file/Path;Landroid/net/Uri;)Z
    ...
    const-string v0, "writing data to dst file is fail - "
...
.method public static saveToFile(Landroid/media/Image;Ljava/io/File;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :cond_0
    invoke-static {p0}, Lcom/samsung/android/app/galaxyraw/core2/util/NativeUtils;->getByteBufferfromImage(Landroid/media/Image;)Ljava/nio/ByteBuffer;
...
.method public static saveToFile(Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;Ljava/io/File;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/DirectBuffer;->get(Ljava/io/File;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
