.class public Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;
    ...
    sput-object v0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;
...
.method protected constructor <init>(Ljava/nio/ByteBuffer;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public capacity()I
    ...
    iget-object p0, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public get(Landroid/os/ParcelFileDescriptor;)V
    ...
    :try_start_2
    sget-object v1, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "channel.write E  Size : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public get(Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object p1, p1, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;

    invoke-virtual {p0, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->get(Ljava/nio/ByteBuffer;)V
...
.method public get(Ljava/io/File;)V
    ...
    :try_start_2
    sget-object v2, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->TAG:Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "channel.write E "
    ...
    invoke-static {v2, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/CLog;->i(Lcom/samsung/android/app/galaxyraw/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public get(Ljava/nio/ByteBuffer;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->limit()I

    move-result v0

    iget-object v1, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public put(Landroid/media/Image;)V
    ...
    invoke-direct {v2, p1}, Lcom/samsung/android/app/galaxyraw/core2/util/StrideInfo;-><init>(Landroid/media/Image;)V

    invoke-static {v0, v1, v2}, Lcom/samsung/android/app/galaxyraw/core2/util/ImageUtils;->getNV21BufferSize(IILcom/samsung/android/app/galaxyraw/core2/util/StrideInfo;)I
    ...
    :cond_2
    :goto_0
    invoke-static {p1}, Lcom/samsung/android/app/galaxyraw/core2/util/NativeUtils;->getJpegSizefromImage(Landroid/media/Image;)I
    ...
    invoke-static {p1, v1}, Lcom/samsung/android/app/galaxyraw/core2/util/NativeUtils;->putByteBufferFromImage(Landroid/media/Image;Ljava/nio/ByteBuffer;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object p1, p0, Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public put(Lcom/samsung/android/app/galaxyraw/core2/util/BufferBase;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
