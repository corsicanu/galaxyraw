.class Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;
...
.method static synthetic lambda$execute$0(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureEventListener;)V
    ...
    invoke-interface {p0}, Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureEventListener;->onCaptureCancelled()V
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->mMakerHolder:Lcom/samsung/android/app/galaxyraw/engine/request/MakerHolder;
    ...
    :try_start_0
    invoke-interface {v1}, Lcom/samsung/android/app/galaxyraw/core2/MakerInterface;->cancelTakePicture()V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->setNextCaptureState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->setNextState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->discard()V
    ...
    iget-object v0, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->mEngine:Lcom/samsung/android/app/galaxyraw/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelStitchingCaptureRequest$-ic_2mbVvyHoC954pZdCQts7T2U;

    invoke-direct {v1, p0}, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelStitchingCaptureRequest$-ic_2mbVvyHoC954pZdCQts7T2U;-><init>(Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->setNextCaptureState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureState;)V
...
.method public synthetic lambda$execute$1$CancelStitchingCaptureRequest()V
    ...
    iget-object p0, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelStitchingCaptureRequest;->mEngine:Lcom/samsung/android/app/galaxyraw/interfaces/InternalEngine;
    ...
    sget-object v0, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelStitchingCaptureRequest$S9B7h2DPIbScRWrvgVPhRuJZmM0;->INSTANCE:Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelStitchingCaptureRequest$S9B7h2DPIbScRWrvgVPhRuJZmM0;
