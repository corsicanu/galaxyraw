.class Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->mMakerHolder:Lcom/samsung/android/app/galaxyraw/engine/request/MakerHolder;
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->setNextCaptureState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->setNextState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->discard()V
    ...
    iget-object v0, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->mEngine:Lcom/samsung/android/app/galaxyraw/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelTakePictureRequest$OcXi5b9eNDF5L6wP8GIUtDV1Q04;

    invoke-direct {v1, p0}, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelTakePictureRequest$OcXi5b9eNDF5L6wP8GIUtDV1Q04;-><init>(Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->setNextCaptureState(Lcom/samsung/android/app/galaxyraw/interfaces/Engine$CaptureState;)V
...
.method public synthetic lambda$execute$1$CancelTakePictureRequest()V
    ...
    iget-object p0, p0, Lcom/samsung/android/app/galaxyraw/engine/request/CancelTakePictureRequest;->mEngine:Lcom/samsung/android/app/galaxyraw/interfaces/InternalEngine;
    ...
    sget-object v0, Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelTakePictureRequest$pxvo2bU-A2mMjssCXiFORt38iic;->INSTANCE:Lcom/samsung/android/app/galaxyraw/engine/request/-$$Lambda$CancelTakePictureRequest$pxvo2bU-A2mMjssCXiFORt38iic;
